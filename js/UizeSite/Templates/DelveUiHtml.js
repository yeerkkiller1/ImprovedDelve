...
+'\n' + '            ) > 0,'
+'\n' + '          persistObserv:{observ: rating, key: \'rating\'+text}">'
+'\n' + '        <div class="fncname" data-bind="text: text"></div>'
+'\n' + '       '
+'\n' + '        <div class="votebuttons">'

+'\n' + '          <!-- doing our work on click instead of checked changed is improper... but the checked events are dumb and onclick is so much easier -->'
+'\n' + '          <input class="vote down" type="radio" value="-1"'
+'\n' + '                 data-bind="clickToggle: {observ: rating, values: [\'-1\', \'0\']}, checked: rating, attr:{name: text}"'
+'\n' + '                 />'
+'\n' + '          <input class="vote up" type="radio" value="1"'
+'\n' + '                 data-bind="clickToggle: {observ: rating, values: [\'1\', \'0\']}, checked: rating"'
+'\n' + '                 />'
+'\n' + '        </div>'
+'\n' + '      </div>'
